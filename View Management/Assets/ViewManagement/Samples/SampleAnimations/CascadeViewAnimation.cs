...
namespace ViewManagement.Samples.SampleAnimations
{
    public class CascadeViewAnimation : ViewAnimation
    {
        ...
        {
            tween = AnimateChildrenScale(0f, 1f, showDuration, Ease.OutBack).SetUpdate(true).OnComplete(() => onComplete?.Invoke());
        }
        ...
        protected override void OnHide(Action onComplete)
        {
            ...
            tween = AnimateChildrenScale(1f, 0f, hideDuration, Ease.OutQuad).SetUpdate(true).OnComplete(() => onComplete?.Invoke());
        }
